...
p <- ggplot(hotelDf, aes(arrival_date_year, is_canceled)) +
  geom_point(aes(color = country, size = is_canceled, alpha = 0.5)) +
  geom_smooth(se = F) + scale_x_log10(label = scales::dollar)
